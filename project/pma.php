...
$ACCESS_PWD='$0lace12'; #!!!IMPORTANT!!! this is script access password, SET IT if you want to protect you DB from public access

#DEFAULT db connection settings
# --- WARNING! --- if you set defaults - it's recommended to set $ACCESS_PWD to protect your db!
$DBDEF=array(
'user'=>"u678535045_Intern3",#required
'pwd'=>"0%55XbFFq7t6", #required
'db'=>"u678535045_srsb42",  #optional, default DB
